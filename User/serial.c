...
*****************************************************************/ 
#include "serial.h"
U8 data ReceiveFrame[20];  	//依次为状态,数据,
U8 data SendFrame[20];  			//依次为状态,数据,
U8 data SendCount;     				//发送字节数
U8 data TotalSendCount;				//发送总数
U8 data ReceiveCount; 		 		//接收字节数
U8 data TotalReceiveCount; 		//接收字节数
