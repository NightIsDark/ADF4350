...
{
   FLADDR idata dest_1_page_start;           // first address in 1st page
                                       // containing <dest>
   FLADDR idata dest_1_page_end;             // last address in 1st page
                                       // containing <dest>
   FLADDR idata dest_2_page_start;           // first address in 2nd page
                                       // containing <dest>
   FLADDR idata dest_2_page_end;             // last address in 2nd page
                                       // containing <dest>
   unsigned idata numbytes_remainder;        // when crossing page boundary,
                                       // number of <src> bytes on 2nd page
   unsigned idata FLASH_pagesize;            // size of FLASH page to update

   FLADDR  idata wptr;                       // write address
   FLADDR  idata rptr;                       // read address

   unsigned idata length;
